	...
	public function settingsDisplay($settings) {
		...
		if(checksubmit()) {
			$dat = array(
				...
				'wxapp_indexs_name' => trim($_GPC['wxapp_indexs_name']),
				'indexs_appid' => trim($_GPC['indexs_appid']),
				'indexs_icon'  => trim($_GPC['indexs_icon']),

				'searchs_name' => trim($_GPC['searchs_name']),
				'searchs_link' => trim($_GPC['searchs_link']),
				'wxapp_searchs_name'=> trim($_GPC['wxapp_searchs_name']),
				'searchs_appid'=> trim($_GPC['searchs_appid']),
				'searchs_icon' => trim($_GPC['searchs_icon']),

				'lessons_name' => trim($_GPC['lessons_name']),
				'lessons_link' => trim($_GPC['lessons_link']),
				'wxapp_lessons_name' => trim($_GPC['wxapp_lessons_name']),
				'lessons_appid'=> trim($_GPC['lessons_appid']),
				'lessons_icon' => trim($_GPC['lessons_icon']),

				'selfs_name' => trim($_GPC['selfs_name']),
				'selfs_link' => trim($_GPC['selfs_link']),
				'wxapp_selfs_name' => trim($_GPC['wxapp_selfs_name']),
				'selfs_appid'=> trim($_GPC['selfs_appid']),
